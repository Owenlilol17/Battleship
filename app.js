document.addEventListener('DOMContentLoaded', () => {
  ...
  function generate(ship) {
    ...
    if (!isTaken && !isAtLeftEdge && !isAtRightEdge) current.forEach(index =>
  ...
  function checkForWins() {
    ...
    if (cpuDestroyerCount + cpuSubmarineCount + cpuCarrierCount + cpuCruiserCount + cpuBattleshipCount === 50) {
